defmodule TestLvCheckboxWeb.UserLiveTest do
  use TestLvCheckboxWeb.ConnCase

  import Phoenix.LiveViewTest

  alias TestLvCheckbox.Accounts

  @create_attrs %{description: "some description", email: "some email", number: 42, username: "some username"}
